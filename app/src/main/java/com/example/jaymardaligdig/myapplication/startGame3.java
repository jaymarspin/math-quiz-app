...
public class startGame3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if(com.example.jaymardaligdig.myapplication.settings.sound == true){
                    startService(new Intent(startGame3.this,musicPlayer.class));
                }
        ...
        dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                Toast.makeText(startGame3.this,"Thank you for playing",Toast.LENGTH_SHORT).show();
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(startGame3.this, home.class));
                    }
                },1000);
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(call == true){
                    ...
                    Toast.makeText(startGame3.this,"Call a friend can only be used once!",Toast.LENGTH_SHORT).show();
                }
            }
        });
        icon2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fifty == true){
                    ...
                    fifty = false;
                }else Toast.makeText(startGame3.this,"You can only use 50/50 once",Toast.LENGTH_SHORT).show();
    ...
    public int no_more(int value){
        data.addScore(value);
        String namer = "";
        Cursor dat = data.data("SELECT * FROM scores WHERE category = 'g6' ORDER BY remarks ASC");
        int final_score = 0;
