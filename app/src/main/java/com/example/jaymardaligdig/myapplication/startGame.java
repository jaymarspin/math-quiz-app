...
public class startGame extends AppCompatActivity implements View.OnClickListener{
   ...
   Hourglass callTime = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if(com.example.jaymardaligdig.myapplication.settings.sound == true){
                    startService(new Intent(startGame.this,musicPlayer.class));
                }
        ...
        dialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            ...
            public void onDismiss(DialogInterface dialog) {
                Toast.makeText(startGame.this,"Thank you for playing",Toast.LENGTH_SHORT).show();
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            if(call == true){
               ...
               callTime = new Hourglass(60000, 1000) {
                ...
                Toast.makeText(startGame.this,"Call a friend can only be used once!",Toast.LENGTH_SHORT).show();
            }
            }
        });
        icon2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fifty == true){
                    ...
                    fifty = false;
                }else Toast.makeText(startGame.this,"You can only use 50/50 once",Toast.LENGTH_SHORT).show();
    ...
    public int no_more(int value){
        data.addScore(value);
        String namer = "";
        Cursor dat = data.data("SELECT * FROM scores WHERE category = 'g4' ORDER BY remarks ASC");
        int final_score = 0;
